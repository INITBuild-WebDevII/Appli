    ...
    <div className="behavioral-question">
            <div className="behavioral-heading">
                ...
                <p>Here is a few tips and tricks to acing those Behavioral Questions!</p>
                 <BehavioralCards  title="Amazon STAR Method"  para="The STAR method is a structured way of answering behavioral interview questions. STAR stands for Situation, Task, Action, and Results!"  />
